...
class TrackAdapter: RecyclerView.Adapter<TrackAdapter.TrackHolder>() {
    ...
    val trackList=arrayListOf<Track>(track1,
        track2,
        track3,
        track4,
        track5)
    ...
    class TrackHolder (item: View):RecyclerView.ViewHolder(item) {
        ...
        trackName.text= track.trackName
            ...
            Glide.with(itemView).load(track.artWorkUrl100).transform(RoundedCorners(2)).placeholder(R.drawable.placeholder_playlist).into(artWork)
